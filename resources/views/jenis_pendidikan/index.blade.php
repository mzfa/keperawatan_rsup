        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col px-0 align-self-center">
                    <h5 class="mb-0 text-color-theme">Data Jenis Pendidikan</h5>
                            ...
                            @foreach($data as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ url('pendidikan/delete/'.Crypt::encrypt($item->jenis_pendidikan_id)) }}" class="btn text-white btn-danger">Hapus</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
